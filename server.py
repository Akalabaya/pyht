                                   ...
                                   if length > 200000000:
                                      ...
                                      while read < length:
                                       ...
                                       for key in form.keys():
                                           ...
                                           os.system("python3 exec.py " + server.request_link + "" + self.path[1:] +" >temp.py")
                                           os.system("python3 temp.py "+base64_string+" > temp.html")
                        ...
                        if self.path[1:].split(".")[len( self.path[1:].split(".") ) - 1] == "html" or mimetypes.guess_type(self.path[1:].split("?")[0])[0] == "text/html": 
                               ...
                               if "?" in self.path[1:]:
                                       try:
                                              ...
                                              base64_bytes = base64.b64encode(sample_string_bytes) 
                                              base64_string = base64_bytes.decode("ascii") 
                                              os.system("python3 exec.py " + server.request_link + "" + self.path[1:].split("?")[0] +" >temp.py")
                                              os.system("python3 temp.py "+" None "+base64_string+" > temp.html")
                                              file_to_open = open("temp.html").read() 
                                       except:
                                              print("error")
                               else:                     
                                       os.system("python3 exec.py " + server.request_link + "" + self.path[1:] + " >temp.py")
                                       os.system("python3 temp.py > temp.html")
                                       file_to_open = open("temp.html").read()
                                       self.send_response(200)
                                       os.remove("temp.py")
                                       os.remove("temp.html")
